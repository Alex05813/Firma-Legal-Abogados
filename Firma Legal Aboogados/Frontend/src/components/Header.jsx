      ...
      <div className="todo-homepage">
        <div className="header-homepage" id="principal">
          ...
          <div className="navegacion-homepage">
            <nav>
              {/* INICIAR SESION */}
              <div className={`login-sidebar-homepage ${isSidebarOpen ? 'open' : ''}`} id="loginSidebar">
                <div className="close-btn-homepage" onClick={closeLoginSidebar}>×</div>
                <div id="loginForm">
                  <h2>ACCEDER</h2>

                  <form className='form-homepage' action="../controllers/loginusuario.php" method="POST">
                    ...
                    <button className="btnlogin-homepage" name="btnlogin-homepage">INICIAR SESIÓN</button>
                  </form>
                </div>
              </div>
              {/* BOTON DE NAVEGACION */}
